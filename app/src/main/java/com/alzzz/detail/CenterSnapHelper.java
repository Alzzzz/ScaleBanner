 ...
 * which use {@link HouseBannerLayoutManager} as its {@link LayoutManager}.
 * <p>
...
public class CenterSnapHelper extends RecyclerView.OnFlingListener {
     ...
     * {@link #snapToCenterView(HouseBannerLayoutManager, HouseBannerLayoutManager.OnPageChangeListener)}
    ...
    private final RecyclerView.OnScrollListener mScrollListener =
            new RecyclerView.OnScrollListener() {
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    ...
                    final HouseBannerLayoutManager layoutManager =
                            (HouseBannerLayoutManager) recyclerView.getLayoutManager();
                    final HouseBannerLayoutManager.OnPageChangeListener onPageChangeListener =
    ...
    public boolean onFling(int velocityX, int velocityY) {
        HouseBannerLayoutManager layoutManager = (HouseBannerLayoutManager) mRecyclerView.getLayoutManager();
        ...
        if (layoutManager.mOrientation == HouseBannerLayoutManager.VERTICAL
            ...
            return true;
        } else if (layoutManager.mOrientation == HouseBannerLayoutManager.HORIZONTAL
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView)
        ...
        if (mRecyclerView != null) {
            ...
            snapToCenterView((HouseBannerLayoutManager) layoutManager,
                    ((HouseBannerLayoutManager) layoutManager).onPageChangeListener);
        }
    }

    void snapToCenterView(HouseBannerLayoutManager layoutManager,
                          HouseBannerLayoutManager.OnPageChangeListener listener) {
        final int delta = layoutManager.getOffsetToCenter();
        if (delta != 0) {
            if (layoutManager.getOrientation()
                    == HouseBannerLayoutManager.VERTICAL)
